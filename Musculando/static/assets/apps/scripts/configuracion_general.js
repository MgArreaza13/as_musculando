...
function EliminarPorcentaje(id) {
	swal({
		  title: '¿Estas Seguro?',
		  text: "¿Estas Seguro de que deseas eliminar este Porcentaje?",
		  type: 'warning',
		  ...
		  confirmButtonText: 'Si, Quiero Eliminarlo!'
           ...
           if(result.value){
		    ...
		    url : '/Configuracion/Porcentaje/Solicitud/Eliminar/Registro/',
		    ...
		    success : function(status) {
		    	if (status == 200) {
		    		...
		    		swal(
					      'Borrado!',
					      'Hemos Borrado satisfactoriamente tu Porcentaje.',
					      'success'
					    );
		        	location.href ="/Configuracion/";
		    	}
		    	else{
		    		swal("OOOh!", "Hemos tenido un problema al borrar su Porcentaje!", "error")
		    	}
		    },
...
// function NuevoMail() {
// 	  swal({
// 	  html: '<h1>Nuevo Email</h1><h3 style="color:blue">Ingrese el Email a registrar</h3>',
// 	  input: 'text',
...
// 		    		swal(
// 					      'Felicidades!',
// 					      'Agregamos Su Email satisfactoriamente.',
// 					      'success'
// 					    );
// 		        	location.href ="/Configuracion/";
// 		    	}
...
// 		    		swal(
// 					      'Error!',
// 					      'Ya habias registrado este correo!.',
// 					      'error'
// 					    );
...
function EliminarMail(id_mail) {
	swal({
		  title: '¿Estas Seguro?',
		  text: "¿Estas Seguro de que deseas eliminar este Email?",
		  type: 'warning',
		  showCancelButton: true,
		  confirmButtonColor: '#3085d6',
		  cancelButtonColor: '#d33',
		  confirmButtonText: 'Si, Quiero Eliminarlo!'
           ...
           if(result.value){
           	...
           	$.ajax({
		    // la URL para la petición
		    url : '/Configuracion/Email/Eliminar/',
		    // la información a enviar
		    // (también es posible utilizar una cadena de datos)
		    data : { 
		    	'id':id_mail,
		    ...
		    success : function(status) {
		    	if (status == 200) {
		    		...
		    		swal(
					      'Borrado!',
					      'Hemos Borrado satisfactoriamente su Email!.',
					      'success'
					    );
		        	location.href ="/Configuracion/";
		    	}
		    	else{
		    		swal("OOOh!", "Hemos tenido un problema al borrar su Email!", "error")
		    	}
		    },
...
function EliminarTermino(id_termino) {
	swal({
		  title: '¿Estas Seguro?',
		  text: "¿Estas Seguro de que deseas eliminar este Texto?",
		  type: 'warning',
		  showCancelButton: true,
		  confirmButtonColor: '#3085d6',
		  cancelButtonColor: '#d33',
		  confirmButtonText: 'Si, Quiero Eliminarlo!'
           ...
           if(result.value){
           	...
           	$.ajax({
		    // la URL para la petición
		    url : '/Configuracion/Terminos/Eliminar/',
		    // la información a enviar
		    // (también es posible utilizar una cadena de datos)
		    data : { 
		    	'id':id_termino,
...
function EnviarTermino(id_termino) {
	swal({
		  title: '¿Estas Seguro?',
		  text: "¿Estas Seguro de que deseas Enviar este Texto?",
		  type: 'warning',
		  showCancelButton: true,
		  confirmButtonColor: '#3085d6',
		  cancelButtonColor: '#d33',
		  confirmButtonText: 'Si, Quiero Enviarlo!'
           ...
           if(result.value){
           	...
           	$.ajax({
		    // la URL para la petición
		    url : '/Configuracion/Terminos/Enviar/',
		    // la información a enviar
		    // (también es posible utilizar una cadena de datos)
		    data : { 
		    	'id':id_termino,
